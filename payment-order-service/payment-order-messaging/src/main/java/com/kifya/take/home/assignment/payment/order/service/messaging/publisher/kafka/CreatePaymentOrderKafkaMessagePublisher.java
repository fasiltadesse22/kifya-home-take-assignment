...
@Slf4j
@Component
public class CreatePaymentOrderKafkaMessagePublisher implements PaymentOrderCreatedRequestMessagePublisher {
    ...
    public CreatePaymentOrderKafkaMessagePublisher(PaymentOrderMessagingDataMapper paymentOrderMessagingDataMapper,
    ...
    @Override
    public void publish(PaymentOrderCreatedEvent paymentOrderCreatedEvent) {
        String orderId = paymentOrderCreatedEvent.getPaymentOrder().getId().getValue().toString();
        log.info("Received PaymentOrderCreatedEvent for orderId: {}", orderId);

        try {
            PaymentRequestAvroModel paymentRequestAvroModel
                    = paymentOrderMessagingDataMapper.orderCreatedEventToPaymentRequestAvroModel(paymentOrderCreatedEvent);
